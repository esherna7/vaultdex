...
import io.github.esherna7.vaultdex.dto.TrackedSetsRequest;
...
public class TrackedSetsController {
    ...
    @PostMapping
    public void trackSet(@AuthenticationPrincipal User currentUser, @RequestBody TrackedSetsRequest request) {
        trackedSetsService.trackSet(currentUser.getId(), request.setCode());
    }
